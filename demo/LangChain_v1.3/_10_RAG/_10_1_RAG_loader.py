...
""" json """
json_docs1 = JSONLoader(
    os.path.join(load_dir, "sample.json"), jq_schema=".[]", text_content=False
).load()
# rprint(json_docs1)
...
pdf_docs = PyPDFLoader(
    os.path.join(load_dir, "sample.pdf"), extraction_mode="plain"
).load()
# rprint(pdf_docs)

""" word (使用 Docx2txtLoader 替代 UnstructuredWordDocumentLoader,
避免 segfault) """
