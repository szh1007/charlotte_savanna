...
messages = [
    (
        "system",
        ("你是专业的智能AI助手, 你可以使用工具来回答用户的问题, 输出格式尽量简洁明确"),
    ),
...
agent = create_agent(
    ...
    response_format=ToolStrategy(
        ...
        # 可以设置 Pydantic 模型用作 tool 调用后的 ToolMessage 的输出内容
        tool_message_content="输出格式化成功!",
        # 默认捕获所有异常
        # (False 关闭自动重试 / string 预设固定字符串 / callable 自定义处理函数)
        handle_errors=True,
    ),
)
