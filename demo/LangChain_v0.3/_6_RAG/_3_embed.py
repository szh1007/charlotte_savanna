...
# # 余弦相似度
# response_docs4 = chroma_db.similarity_search_with_relevance_scores(
#     query="介绍量子力学"
# )
...
# MMR 最大边际相关性 0-1
response_docs5 = chroma_db.max_marginal_relevance_search(
    query="介绍量子力学", lambda_mult=0.5
)
