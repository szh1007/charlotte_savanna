...
template2 = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "你是一个AI专家, 你的名字叫小智, 已知对话历史: {history}",
        ),
        ("human", "{input}"),
    ]
)
...
#     {"input": "你好我叫 Charlotte"}, {"output": "你好, Charlotte"}
# )
# token_memory.save_context(
#     {"input": "我的女朋友叫 Savanna"}, {"output": "好的, 我知道了"}
# )
...
summary_memory.save_context(
    {"input": "你好, 我叫 Charlotte"}, {"output": "你好, Charlotte"}
)
summary_memory.save_context(
    {"input": "我的女朋友叫 Savanna"}, {"output": "好的, 我知道了"}
)
...
# )
# mix_memory.save_context(
#     {"input": "我是AI专业毕业的研究生"}, {"output": "好的,我知道了"}
# )
...
"""
3.极简写法: ConversationChain 有默认的提示词模板,
    默认变量: history、input、response
"""
