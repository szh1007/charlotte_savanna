...
template3 = ChatPromptTemplate.from_messages(
    [
        (
            "human",
            "{actor1}和{actor2}分别主演的所有电影的详细汇总信息",
        ),
    ]
)
...
template4 = ChatPromptTemplate.from_messages(
    [
        (
            "human",
            "已知{actor1}和{actor2}电影信息描述: "
            "{movies}, 综合{plat1}和{plat2}的评价选出普遍好评率最高的{top}部",
        ),
    ]
)
...
# result2 = s_chain.invoke(
#     {"actor1": "沈腾", "actor2": "马丽", "plat1": "豆瓣", "plat2": "猫眼", "top": 3}
# )
