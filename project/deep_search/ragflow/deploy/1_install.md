...
![image-20250619102651808](./assets/1.png)
...
![image-20250619102817297](./assets/2.png)

镜像选择CentOS核Ubuntu都可以，文档里使用了Ubuntu。选择后点击下一步。

![image-20250619103252815](./assets/3.png)

![image-20250619103307728](./assets/4.png)

拉满带宽上限，新建安全组，把常用的端口都开启

![image-20250619103457368](./assets/5.png)

命名实例，设置密码，进行下一步

![image-20250619103548187](./assets/6.png)

开通

![image-20250619103615844](./assets/7.png)

创建好了，通过这个公网IP，端口使用22，账号ubuntu，密码使用你设置的密码。使用你的远程连接工具连接即可

![image-20250619103844777](./assets/8.png)
...
如果安装docker 的时候出现这个界面，直接回车就可以！	![001](./assets/9.png)
...
![image-20250619105104648](./assets/11.png)
...
![image-20250619105258790](./assets/12.png)
...
![image-20250619110235982](./assets/13.png)
...
![image-20250619112542899](./assets/14.png)

![image-20250619112558136](./assets/15.png)

![image-20250619112615974](./assets/16.png)

![image-20250619112659812](./assets/17.png)

然后回到终端，vim /etc/ssh/sshd_config

这两项去掉注释符号，变成yes

![image-20250619112847346](./assets/18.png)
...
![image-20250619113345673](./assets/19.png)
...
![image-20250619115614270](./assets/20.png)
...
i![image-20250619120100518](./assets/21.png)
...
![image-20250619134514861](./assets/22.png)

现在配置全部搞定，在docker目录下开始启动

![image-20250619134637133](./assets/23.png)
...
![image-20250619134716042](./assets/24.png)

安装完毕

![image-20250619135921801](./assets/25.png)

### 2.3 配置RAGFlow知识库

直接复制公网ip，到浏览器进行访问即可进入页面

![image-20250619135912891](./assets/26.png)

先注册一个账号

![image-20250619140313102](./assets/27.png)

![image-20250619140339250](./assets/28.png)

然后登陆

![image-20250619140358858](./assets/29.png)

设置一下中文

![image-20250619140428425](./assets/30.png)
...
![image-20250619140855488](./assets/31.png)

点击模型供应商，下滑寻找Tongyi-Qianwen

![image-20250619140605716](./assets/32.png)

点击添加模型，然后把自己的API-KEY粘贴进去

设置默认模型

![image-20250619141933424](./assets/33.png)

设置自己的模型，千问系列的优点是模型十分全面，大语言模型、多模态模型、重排模型、向量化模型都可以使用，只需要配置其API就可以完成大多数任务需求。

![image-20250619142044389](./assets/34.png)

设置完成后，就需要开始配置自己的知识库了。这里准备好了一些测试使用的知识库文件，大家可以直接使用，也可以根据自己的兴趣去寻找收集其他知识文档。

![image-20250619144708406](./assets/35.png)

创建知识库

![image-20250619144741192](./assets/36.png)

划到最下面点击保存即创建成功

![image-20250619144812672](./assets/37.png)

新增文件，把准备好的文件进行上传，**上传后务必点击解析进行文档解析！**这里的pdf是调用多模态模型进行分析，可能会耗时比较长，请耐心等待

![image-20250619144958440](./assets/38.png)

解析成功，如果解析失败了就一个一个再重新解析。

![image-20250619145801880](./assets/39.png)

创建知识助手

**注意，这里的助理描述一定要详细填写，否则在后续调用API的时候会出现无法灵活处理问题的情况**

![image-20250619150034877](./assets/40.png)

​	这里创建完成后新建一个对话，做出一个简单的相关问题提问，回答中会给出每一条信息的来源标识，并且会给出源文件。可见，其并不是靠着自己的强大模型能力完成的，而是根据知识库的信息检索输出的。

![image-20250619150230019](./assets/41.png)

![image-20250619150315666](./assets/42.png)

之后将这几种数据文件全部新建知识库，并且创建知识助手。可以让一个助手掌握一个或多个知识库，根据具体情况灵活调整即可。

依次创建成功

![image-20250619152749961](./assets/43.png)

创建出助手进行测试

![image-20250619153004516](./assets/44.png)
...
![image-20250620105319201](./assets/45.png)
...
![image-20250620105521620](./assets/46.png)

删除关键字

![image-20250620105701633](./assets/47.png)
