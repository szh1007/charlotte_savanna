...
def create_knowledge_base(kb_name: str, description: str = "") -> str:
    ...
    try:
        ...
        kb  = rag.create_dataset(name=kb_name,description="ragflow的知识库，导入中国刑法！！",embedding_model="text-embedding-v3@Tongyi-Qianwen")
        ...
        try:
            ...
            for part in response_generator:
                if hasattr(part, "content") and part.content:
                    # 大模型 -> stream  [1,2,3,4,5,6]  1  2 3 4 5 6
                    # ragflow -> stream   [1,2,3,4,5,6]  1 2 123  12345  123456
